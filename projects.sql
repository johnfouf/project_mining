...
or  (fundingclass1="SNSF" and regexprmatches('(?:\bsnsf\b)|(?:swiss national (?:science)?\s?foundation\b)',lower(j2s(prev,middle,next))) and
regexpr('0{0,1}(\d{5,6})',middle)=regexpr('0{0,1}(\d{5,6})$',grantid))
